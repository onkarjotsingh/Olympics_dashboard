...
st.sidebar.image("https://149448277.v2.pressablecdn.com/wp-content/uploads/2020/03/Olympic-rings-1.jpg")
...
if user_menu == 'Overall Analysis':
    ...
    ### Nation Over Time
    nations_over_time = helper.nation_over_time(df)
